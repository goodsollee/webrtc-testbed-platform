...
test-apps/CMakeFiles/test-client.dir/test-client.c.o: ../test-apps/test-client.c
test-apps/CMakeFiles/test-client.dir/test-client.c.o: test-apps/CMakeFiles/test-client.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/libwebsockets/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object test-apps/CMakeFiles/test-client.dir/test-client.c.o"
	cd /tmp/libwebsockets/build/test-apps && /usr/bin/clang $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -MD -MT test-apps/CMakeFiles/test-client.dir/test-client.c.o -MF CMakeFiles/test-client.dir/test-client.c.o.d -o CMakeFiles/test-client.dir/test-client.c.o -c /tmp/libwebsockets/test-apps/test-client.c
...
test-apps/CMakeFiles/test-client.dir/test-client.c.i: cmake_force
	...
	cd /tmp/libwebsockets/build/test-apps && /usr/bin/clang $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /tmp/libwebsockets/test-apps/test-client.c > CMakeFiles/test-client.dir/test-client.c.i
...
test-apps/CMakeFiles/test-client.dir/test-client.c.s: cmake_force
	...
	cd /tmp/libwebsockets/build/test-apps && /usr/bin/clang $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /tmp/libwebsockets/test-apps/test-client.c -o CMakeFiles/test-client.dir/test-client.c.s
...
bin/libwebsockets-test-client: test-apps/CMakeFiles/test-client.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/libwebsockets/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable ../bin/libwebsockets-test-client"
	cd /tmp/libwebsockets/build/test-apps && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-client.dir/link.txt --verbose=$(VERBOSE)
...
test-apps/CMakeFiles/test-client.dir/clean:
	cd /tmp/libwebsockets/build/test-apps && $(CMAKE_COMMAND) -P CMakeFiles/test-client.dir/cmake_clean.cmake
.PHONY : test-apps/CMakeFiles/test-client.dir/clean

test-apps/CMakeFiles/test-client.dir/depend:
	cd /tmp/libwebsockets/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/libwebsockets /tmp/libwebsockets/test-apps /tmp/libwebsockets/build /tmp/libwebsockets/build/test-apps /tmp/libwebsockets/build/test-apps/CMakeFiles/test-client.dir/DependInfo.cmake --color=$(COLOR)
